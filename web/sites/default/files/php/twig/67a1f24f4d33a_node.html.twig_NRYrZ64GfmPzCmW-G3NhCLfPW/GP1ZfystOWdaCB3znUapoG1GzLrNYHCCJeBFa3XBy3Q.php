...
/* themes/custom/sdc_custom/templates/content/node.html.twig */
class __TwigTemplate_dd02304bdbe007854394f71e0f12aedf extends Template
{
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass(($context["view_mode"] ?? null)))) : (""))];
  ...
  ";
        // line 106
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->renderVar(Twig\Extension\CoreExtension::include($this->env, $context, "sdc_custom:my-banner", ["heading" =>         // line 107
($context["label"] ?? null), "ctaText" => "Click me!", "ctaHref" => "https://www.example.org", "ctaTarget" => "_blank", "image" => $this->extensions['Drupal\Core\Template\TwigExtension']->getFileUrl(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (($_v0 = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source,         // line 111
($context["content"] ?? null), "field_image", [], "any", false, false, true, 111), 0, [], "any", false, false, true, 111)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0["#item"] ?? null) : CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["content"] ?? null), "field_image", [], "any", false, false, true, 111), 0, [], "any", false, false, true, 111), "#item", [], "array", false, false, true, 111)), "entity", [], "any", false, false, true, 111), "uri", [], "any", false, false, true, 111), "value", [], "any", false, false, true, 111))]));
        // line 112
        yield "
  </section>
...
";
    ...
    {
        return "themes/custom/sdc_custom/templates/content/node.html.twig";
    }
    ...
    {
        return array (  149 => 112,  147 => 111,  146 => 107,  145 => 106,  136 => 101,  132 => 99,  129 => 98,  123 => 95,  114 => 93,  109 => 92,  103 => 89,  100 => 88,  98 => 87,  95 => 86,  93 => 85,  88 => 84,  80 => 81,  75 => 80,  73 => 79,  69 => 78,  65 => 77,  60 => 76,  58 => 73,  57 => 72,  56 => 71,  55 => 70,  54 => 69,  53 => 68,  52 => 66,  49 => 64,  47 => 63,  44 => 62,);
    }
...
<article{{ attributes.addClass(classes) }}>
  ...
  <section>
  {{ include('sdc_custom:my-banner', {
  heading: label,
  ctaText: 'Click me!',
  ctaHref: 'https://www.example.org',
  ctaTarget: '_blank',
  image: file_url(content.field_image.0['#item'].entity.uri.value),
}) }}
  </section>

", "themes/custom/sdc_custom/templates/content/node.html.twig", "/var/www/html/web/themes/custom/sdc_custom/templates/content/node.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 63, "if" => 79);
        static $filters = array("clean_class" => 63, "escape" => 76, "t" => 93, "without" => 101);
        static $functions = array("include" => 106, "file_url" => 111);
